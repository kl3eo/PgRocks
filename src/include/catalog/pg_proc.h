...
DATA(insert OID = 8889 (  row_to_json_rocks	           PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 20 "23 2249" _null_ _null_ _null_ _null_ _null_ row_to_json_rocks _null_ _null_ _null_ ));
DATA(insert OID = 8890 (  row_to_json_rocks_sst	       PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 20 "23 2249" _null_ _null_ _null_ _null_ _null_ row_to_json_rocks_sst _null_ _null_ _null_ ));
DATA(insert OID = 8893 (  row_to_json_rocks_batch      PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 20 "23 2249" _null_ _null_ _null_ _null_ _null_ row_to_json_rocks_batch _null_ _null_ _null_ ));
DATA(insert OID = 8895 (  row_to_csv_rocks             PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 20 "23 2249" _null_ _null_ _null_ _null_ _null_ row_to_csv_rocks _null_ _null_ _null_ ));
...
DATA(insert OID = 8901 (  rocks_json_to_json		   PGNSP PGUID 12 1 0 0 0 f f f f t f s s 2 0 114 "23 20" _null_ _null_ _null_ _null_ _null_ rocks_json_to_json _null_ _null_ _null_ ));
...
DATA(insert OID =  8892 (  rocks_close		     PGNSP PGUID 12 1 0 0 0 f f f f t f s s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ rocks_close _null_ _null_ _null_ ));
DESCR("rocks close db");
